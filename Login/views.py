from AcademicDetails.models import Login
    ...
    def login(request):
        ...
        for item in total_LoginDetails:
            ...
            if item['password'] == str(Encrypted_Password):
                ...
                if item['position_college'] == 'True':
                    print("Success Fill Form")
                    return HttpResponse("College")

                elif item['position_hod'] == 'True':
                    print("Success Fill Form")
                    return HttpResponse("HOD")

                elif item['position_teacher'] == 'True':
                    print("Success Fill Form")
                    return HttpResponse("Teacher")

                elif item['position_student'] == 'True':
                    if item['personality_form_check'] == 'False':
                        print("Success Fill Form")
                        return HttpResponse("Student Fill Form")
                    else:
                        print("Success Password")
